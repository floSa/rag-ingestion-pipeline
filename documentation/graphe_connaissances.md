...
- **`Picture`** / **`Table`** : Nœuds Média portant `media_url` (l'adresse de l'objet) et `object_key` (sa clé nue), qui désignent l'objet stocké dans le [stockage d'objets](stockage_objets.md).
